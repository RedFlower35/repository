...
function updateMetrics(metrics) {
    document.getElementById("r2-score").textContent = metrics.r2_score.toFixed(4);
    ...
    document.getElementById("coefficient").textContent = metrics.coefficient.toFixed(4);
